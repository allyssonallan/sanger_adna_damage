...
class ConsensusStep:
    ...
    def execute(self, directories: Dict[str, Path]) -> Dict[str, int]:
        ...
        for sample_name, hvs_regions in sample_hvs_groups.items():
            ...
            for hvs_region, files in hvs_regions.items():
                ...
                alignment_output = directories["aligned"] / f"{sample_name}_{hvs_region}_aligned.fasta"
                consensus_output = directories["consensus"] / f"{sample_name}_{hvs_region}_consensus.fasta"
    ...
    def _group_files_by_sample_and_region(self, fasta_files: list) -> Dict[str, Dict[str, Dict[str, Path]]]:
        """
