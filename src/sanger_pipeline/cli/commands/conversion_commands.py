...
@click.option('--reference', '-r', default='ref/rCRS.fasta', help='Reference sequence file (default: ref/rCRS.fasta)')
@click.option('--method', '-m', default='regional', type=click.Choice(['regional', 'direct', 'aligned']), 
